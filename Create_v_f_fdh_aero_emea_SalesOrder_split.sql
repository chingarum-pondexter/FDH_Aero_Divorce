...
Create VIEW [etl].[v_fdh_aero_emea_SalesOrder_split] AS
...
(
    ...
    left join etl.v_d_FDH_Aero_Entity ae ON
        ae.DPT_AUTO_KEY = po.DPT_AUTO_KEY
    WHERE ae.Divisionid = 25
)
